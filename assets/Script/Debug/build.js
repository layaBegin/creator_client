...
/* Refer to https://github.com/componentjs/require2/blob/master/lib/require2.js */
/**
...
function require2(path, parent, orig) {
  ...
  if (null == resolved) {
    orig = orig || path;
    parent = parent || 'root';
    var err = new Error('Failed to require2 "' + orig + '" from "' + parent + '"');
    err.path = orig;
    err.parent = parent;
    err.require2 = true;
    throw err;
  ...
  var module = require2.modules[resolved];

  // perform real require2()
  // by invoking the module's
  // registered function
  if (!module.exports) {
    module.exports = {};
    module.client = module.component = true;
    module.call(this, module.exports, require2.relative(resolved), module);
  }
...
require2.resolve = function (path) {
  ...
  for (var i = 0; i < paths.length; i++) {
    var path = paths[i];
    if (has.call(require2.modules, path)) return path;
  }

  if (has.call(require2.aliases, index)) {
    return require2.aliases[index];
  }
};
...
require2.normalize = function (curr, path) {
  var segs = [];
...
require2.register = function (path, definition) {
  require2.modules[path] = definition;
};
...
require2.alias = function (from, to) {
  if (!has.call(require2.modules, from)) {
    throw new Error('Failed to alias "' + from + '", it does not exist');
  }
  require2.aliases[to] = from;
};

/**
 * Return a require2 function relative to the `parent` path.
 *
 * @param {String} parent
 * @return {Function}
 * @api private
...
require2.relative = function (parent) {
  var p = require2.normalize(parent, '..');
  ...
  /**
   * The relative require2() itself.
   */

  function localRequire(path) {
    var resolved = localRequire.resolve(path);
    return require2(resolved, parent, path);
  }
  ...
  localRequire.resolve = function (path) {
    ...
    if ('.' == c) return require2.normalize(p, path);
  ...
  localRequire.exists = function (path) {
    return has.call(require2.modules, localRequire.resolve(path));
  };

  return localRequire;
};
require2.register("component-indexof/index.js", function (exports, require2, module) {
...
require2.register("component-emitter/index.js", function (exports, require2, module) {

  /**
   * Module dependencies.
   */

  var index = require2('indexof');
...
require2.register("node-pinus-pinus-protocol/lib/protocol.js", function (exports, require2, module) {
...
require2.register("pinusnode-pinus-protobuf/lib/client/protobuf.js", function (exports, require2, module) {
...
require2.register("pinusnode-pinus-jsclient-websocket/lib/pinus-client.js", function (exports, require2, module) {
  (function () {
...
require2.register("boot/index.js", function (exports, require2, module) {
  var Emitter = require2('emitter');
  window.EventEmitter = Emitter;

  var protocol = require2('pinus-protocol');
  window.Protocol = protocol;

  var protobuf = require2('pinus-protobuf');
  window.protobuf = protobuf;

  var pinus = require2('pinus-jsclient-websocket');
  window.pinus = pinus;

});
require2.alias("boot/index.js", "pinus-client/deps/boot/index.js");
require2.alias("component-emitter/index.js", "boot/deps/emitter/index.js");
require2.alias("component-indexof/index.js", "component-emitter/deps/indexof/index.js");

require2.alias("node-pinus-pinus-protocol/lib/protocol.js", "boot/deps/pinus-protocol/lib/protocol.js");
require2.alias("node-pinus-pinus-protocol/lib/protocol.js", "boot/deps/pinus-protocol/index.js");
require2.alias("node-pinus-pinus-protocol/lib/protocol.js", "node-pinus-pinus-protocol/index.js");

require2.alias("pinusnode-pinus-protobuf/lib/client/protobuf.js", "boot/deps/pinus-protobuf/lib/client/protobuf.js");
require2.alias("pinusnode-pinus-protobuf/lib/client/protobuf.js", "boot/deps/pinus-protobuf/index.js");
require2.alias("pinusnode-pinus-protobuf/lib/client/protobuf.js", "pinusnode-pinus-protobuf/index.js");

require2.alias("pinusnode-pinus-jsclient-websocket/lib/pinus-client.js", "boot/deps/pinus-jsclient-websocket/lib/pinus-client.js");
require2.alias("pinusnode-pinus-jsclient-websocket/lib/pinus-client.js", "boot/deps/pinus-jsclient-websocket/index.js");
require2.alias("pinusnode-pinus-jsclient-websocket/lib/pinus-client.js", "pinusnode-pinus-jsclient-websocket/index.js");
