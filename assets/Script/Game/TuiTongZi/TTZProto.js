...
proto.REDLIMIT_ERROR = 1000; //限红错误 超出最大值或者最低最小值
proto.getRedLimitErrorData = function (direction) {
	return {
...
// 游戏状态推送
proto.gameStatusChangePushData = function (gameStatus, time) {
	return {
...
// 游戏结果推送
proto.gameResoutPushData = function (resout, profitPercentage, baseScoreArr) {
	return {
