...
cc.Class({
    ...
    initWidget(fishInfo, callback, fishDelay, moveTime) {
        ...
        //     urlArr.push("ShenHaiBuYu/Fish/fish" + fishNo + "_" + tempStr);
        // }
        let fishNo = this.fishTypeInfo.resIndex + 1;
    ...
    createMoveAction: function () {
        ...
        switch (this.fishInfo.fishTraceType) {
            ...
            case fishConfig.FishTraceType.Bezier:
                // let ShenHaiBuYuBezierBy = require("./ShenHaiBuYuFishBezierBy");
                // let action = new ShenHaiBuYuBezierBy();
                // let action = new ShenHaiBuYuFishBezierBy();
