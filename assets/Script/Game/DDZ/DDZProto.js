...
proto.cardType = {
    ...
    BOMB_CARD: 11,              // 炸弹
    MISSILE_CARD: 12,           // 火箭
    FOUR_LINE_TAKE_ONEDOUBLE: 13,      // 四带一对
...
proto.gameSendCardPush = function (curChairID, selfCardArr, outcardtime, callbankerscore) {
    return {
        ...
        data: {
            ...
            callbankerscore: callbankerscore
        }
    };
};
...
proto.gameUserSnatchLandlordPush = function (score, curChairID, chairID, time, callbankerscore) {
    return {
...
proto.gameUserOutCardPush = function (chairID, curChairID, outCardArr, leftCardCount, time) {
    return {
...
// 游戏结果推送
proto.gameResultPush = function (allCardArr, scoreChangeArr, bombTimes, nicknameArr, isSpring, isLandWin, profitPercentage) {
    return {
