...
cc.Class({
    ...
    initWidget(fishInfo, callback, fishDelay, moveTime) {
        ...
        //     urlArr.push("ShenShouTianXia/Fish/fish" + fishNo + "_" + tempStr);
        // }
        let fishNo = this.fishTypeInfo.resIndex + 1;
        let fishUrl = "ShenShouTianXia/Fish/fish" + fishNo;
    ...
    createMoveAction: function () {
        ...
        switch (this.fishInfo.fishTraceType) {
            ...
            case fishConfig.FishTraceType.Bezier:
                // let ShenShouTianXiaBezierBy = require("./ShenShouTianXiaFishBezierBy");
                // let action = new ShenShouTianXiaBezierBy();
                // let action = new ShenShouTianXiaFishBezierBy();
