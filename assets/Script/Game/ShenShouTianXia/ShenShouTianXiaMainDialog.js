...
let gameProto = require('./API/ShenShouTianXiaProto');
let utils = require("../../Shared/utils");
let fishConfig = require("./API/ShenShouTianXiaConfig");
...
cc.Class({
    ...
    properties: {
        ...
        fireControlWidgetCtrl: require('ShenShouTianXiaFireControl'),

        effectCtrl: require("ShenShouTianXiaEffectControl"),
    ...
    start() {
        ...
        this.bgmList = ["ShenShouTianXia/sound/bgm/bgm1", "ShenShouTianXia/sound/bgm/bgm2", "ShenShouTianXia/sound/bgm/bgm3", "ShenShouTianXia/sound/bgm/bgm4"];
        ...
        if (router === 'RoomMessagePush') {
            if (msg.type === roomProto.USER_LEAVE_ROOM_PUSH) {
                if (msg.data.roomUserInfo.userInfo.uid === Global.Player.getPy('uid')) {
                    ViewMgr.goBackHall(Config.GameType.SSTX);
                } else {
    ...
    onBtnClick: function (event, params) {
        ...
        if (params === "exit") {
            ...
            if (musicVolume > 0) {
                ...
                musicVolume = 0;
                Global.CCHelper.updateSpriteFrame('ShenShouTianXia/music_off_btn', musicSpr);
            } else {
                ...
                Global.CCHelper.updateSpriteFrame('ShenShouTianXia/music_on_btn', musicSpr);
            }
            ...
            if (soundVolume > 0) {
                ...
                soundVolume = 0;
                Global.CCHelper.updateSpriteFrame('ShenShouTianXia/effect_off_btn', effectSpr);
            } else {
                ...
                Global.CCHelper.updateSpriteFrame('ShenShouTianXia/effect_on_btn', effectSpr);
            }
            AudioMgr.setSoundVolume(Number(soundVolume));
        } else if (params === "help") {
            Global.DialogManager.createDialog("ShenShouTianXia/ShenShouTianXiaHelpDialog");
    ...
    gameInit: function (gameData, roomUserInfoArr) {
        ...
        let backStr = "ShenShouTianXia/background/bg" + this.backIndex;
    ...
    onUserEntry: function (roomUserInfo, curWinGold) {
        ...
        let ctrl = node.getComponent("ShenShouTianXiaCannonControl");
    ...
    onSelfFire: function (targetWorldPoint) {
        ...
        this.playSound('ShenShouTianXia/sound/effect/fire1', false, 0.3);
    ...
    showSceneBullet: function (bulletData) {
        ...
        let bulletCtrl = node.getComponent('ShenShouTianXiaBulletControl');
    ...
    onFire: function (chairID, bulletdate) {
        ...
        this.playSound('ShenShouTianXia/sound/effect/fire1', false, 0.05);
    ...
    onBeShot: function (bullet, fishCtrl) {
        // 移除子弹
        bullet.onShootFish();
        // this.playSound("ShenShouTianXia/sound/effect/net2", false, 0.3);
        // 播放爆炸动画
        let boomAnim = null;
    ...
    onCapture: function (data) {
        ...
        this.playSound('ShenShouTianXia/sound/effect/coin2', false, 0.3);
    ...
    playDieSound: function (fishTypeID, fishID) {
        if (fishTypeID === fishConfig.FishKind.LocalBomb || fishTypeID === fishConfig.FishKind.FixBomb
            ...
            if (fishID % 2 == 0) {
                this.playSound("ShenShouTianXia/sound/effect/boom", false, 0.6);
            } else {
                this.playSound("ShenShouTianXia/sound/effect/superarm", false, 0.6);
            }
            return;
        }
        if (fishTypeID <= fishConfig.FishKind.FishKind10) {
            this.playSound("ShenShouTianXia/sound/effect/" + (fishID % 2 == 0 ? "hit0" : "hit1"), false, 1);
        }
        else {
            this.playSound("ShenShouTianXia/sound/effect/" + (fishID % 2 == 0 ? "m" : "f") + (fishID % 7 + 1), false, 1);
        }
    },
    ...
    createLightning: function (startPos, endPos) {
        ...
        let ctrl = node.getComponent("ShenShouTianXiaLighntingWidgetControl");
    ...
    addFish: function (fishInfo, fishDelay, isInit, fixTime) {
        ...
        let ctrl = node.getComponent("ShenShouTianXiaFishCtrl");
    ...
    showSpray() {
        ...
        let ctrl = sprayNode.getComponent("ShenShouTianXiaSprayWidgetControl");
        ctrl.setInfo(false, sprayActionTime);
        this.playSound("ShenShouTianXia/sound/effect/wave", false, 0.5);
    },
    ...
    loadFishArray2: function (fishDataArray, actionTime) {
        ...
        for (let i = 0; i < len; ++i) {
            ...
            let ctrl = fishNode.getComponent("ShenShouTianXiaFishCtrl");
