...
gameLogic.RATE_XIANTW = 2;	// 赢-闲天王
gameLogic.RATE_ZHUANGTW = 2;	// 赢-庄天王
gameLogic.RATE_TONGDIANPING = 32;	// 同点平
...
gameLogic.WIN_XIANTW = 32;	// 赢-闲天王
gameLogic.WIN_ZHUANGTW = 64;	// 赢-庄天王
gameLogic.WIN_TONGDIANPING = 128;	// 同点平
...
gameLogic.getRateByType = function (type) {
	...
	if (type === gameLogic.WIN_XIANTW) {
		return gameLogic.RATE_XIANTW;
	}
	if (type === gameLogic.WIN_XIANTW) {
		return gameLogic.RATE_XIANTW;
	}
	if (type === gameLogic.WIN_TONGDIANPING) {
		return gameLogic.RATE_TONGDIANPING;
	}
};
