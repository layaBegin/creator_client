...
cc.Class({
    ...
    setValue: function (cardData, cb) {
        ...
        var color = ERNNLogic.getCardColor(cardData);
        var value = ERNNLogic.getCardNumber(cardData);
    ...
    showBack: function (show) {
        if (show) {
            ...
            this.cardBack.node.rotationX = 0;
            this.cardBack.node.rotationY = -90;
        }
    },
    runFlopCard: function (cb) {
        this.cardBack.node.rotationX = 0;
        this.cardBack.node.rotationY = 0;
        this.cardFace.rotationX = 0;
        this.cardFace.rotationY = -90;
        ...
        this.cardFace.runAction(cc.sequence(cc.delayTime(0.1), action.clone(), cc.callFunc(cb)));
    ...
    onButtonClick: function (event, param) {
        ...
        Global.MessageCallback.emitCustomMessage('ONCARDSHOOT', this.isShoot);
