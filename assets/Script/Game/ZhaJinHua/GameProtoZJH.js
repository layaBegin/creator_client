...
proto.gameStartPush = function (stakeLevel, firstXiaZhu, goldSumAmount, round, userStakeCountArr, bankerchair, operationtime) {
    return {
        ...
        data: {
            ...
            bankerchair: bankerchair,
            operationtime: operationtime
        }
    }
};

proto.chairTurnPush = function (chairId, currentStakeLevel, currentMultiple, canCompare, operationtime) {
    return {
...
proto.gameEndPush = function (winType, winnerchairId, userCardTypeArr, userCardIndexArr, scoreChangeArr, profitPercentage) {
    return {
