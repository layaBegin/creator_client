...
let gameProto = require('./API/JinChanBuYuProto');
let utils = require("../../Shared/utils");
let fishConfig = require("./API/JinChanBuYuConfig");
...
cc.Class({
    ...
    properties: {
        ...
        fireControlWidgetCtrl: require('JinChanBuYuFireControl'),

        effectCtrl: require("JinChanBuYuEffectControl"),
    ...
    start() {
        ...
        this.bgmList = ["JinChanBuYu/sound/bgm/bgm1", "JinChanBuYu/sound/bgm/bgm2", "JinChanBuYu/sound/bgm/bgm3", "JinChanBuYu/sound/bgm/bgm4"];
        ...
        if (router === 'RoomMessagePush') {
            if (msg.type === roomProto.USER_LEAVE_ROOM_PUSH) {
                if (msg.data.roomUserInfo.userInfo.uid === Global.Player.getPy('uid')) {
                    ViewMgr.goBackHall(Config.GameType.JCBY);
                } else {
    ...
    onBtnClick: function (event, params) {
        ...
        if (params === "exit") {
            ...
            if (musicVolume > 0) {
                ...
                musicVolume = 0;
                Global.CCHelper.updateSpriteFrame('JinChanBuYu/music_off_btn', musicSpr);
            } else {
                ...
                Global.CCHelper.updateSpriteFrame('JinChanBuYu/music_on_btn', musicSpr);
            }
            ...
            if (soundVolume > 0) {
                ...
                soundVolume = 0;
                Global.CCHelper.updateSpriteFrame('JinChanBuYu/effect_off_btn', effectSpr);
            } else {
                ...
                Global.CCHelper.updateSpriteFrame('JinChanBuYu/effect_on_btn', effectSpr);
            }
            AudioMgr.setSoundVolume(Number(soundVolume));
        } else if (params === "help") {
            Global.DialogManager.createDialog("JinChanBuYu/JinChanBuYuHelpDialog");
    ...
    gameInit: function (gameData, roomUserInfoArr) {
        ...
        let backStr = "JinChanBuYu/background/bg" + this.backIndex;
    ...
    onUserEntry: function (roomUserInfo, curWinGold) {
        ...
        let ctrl = node.getComponent("JinChanBuYuCannonControl");
    ...
    onSelfFire: function (targetWorldPoint) {
        ...
        this.playSound('JinChanBuYu/sound/effect/fire1', false, 0.3);
    ...
    showSceneBullet: function (bulletData) {
        ...
        let bulletCtrl = node.getComponent('JinChanBuYuBulletControl');
    ...
    onFire: function (chairID, bulletdate) {
        ...
        this.playSound('JinChanBuYu/sound/effect/fire1', false, 0.05);
    ...
    onBeShot: function (bullet, fishCtrl) {
        // 移除子弹
        bullet.onShootFish();
        // this.playSound("JinChanBuYu/sound/effect/net2", false, 0.3);
        // 播放爆炸动画
        let boomAnim = null;
    ...
    onCapture: function (data) {
        ...
        this.playSound('JinChanBuYu/sound/effect/coin2', false, 0.3);
    ...
    playDieSound: function (fishTypeID, fishID) {
        if (fishTypeID === fishConfig.FishKind.LocalBomb || fishTypeID === fishConfig.FishKind.FixBomb
            ...
            if (fishID % 2 == 0) {
                this.playSound("JinChanBuYu/sound/effect/boom", false, 0.6);
            } else {
                this.playSound("JinChanBuYu/sound/effect/superarm", false, 0.6);
            }
            return;
        }
        if (fishTypeID <= fishConfig.FishKind.FishKind10) {
            this.playSound("JinChanBuYu/sound/effect/" + (fishID % 2 == 0 ? "hit0" : "hit1"), false, 1);
        }
        else {
            this.playSound("JinChanBuYu/sound/effect/" + (fishID % 2 == 0 ? "m" : "f") + (fishID % 7 + 1), false, 1);
        }
    },
    ...
    createLightning: function (startPos, endPos) {
        ...
        let ctrl = node.getComponent("JinChanBuYuLighntingWidgetControl");
    ...
    addFish: function (fishInfo, fishDelay, isInit, fixTime) {
        ...
        let ctrl = node.getComponent("JinChanBuYuFishCtrl");
    ...
    showSpray() {
        ...
        let ctrl = sprayNode.getComponent("JinChanBuYuSprayWidgetControl");
        ctrl.setInfo(false, sprayActionTime);
        this.playSound("JinChanBuYu/sound/effect/wave", false, 0.5);
    },
    ...
    loadFishArray2: function (fishDataArray, actionTime) {
        ...
        for (let i = 0; i < len; ++i) {
            ...
            let ctrl = fishNode.getComponent("JinChanBuYuFishCtrl");
