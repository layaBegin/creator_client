...
cc.Class({
    ...
    initWidget(fishInfo, callback, fishDelay, moveTime) {
        ...
        //     urlArr.push("JinChanBuYu/Fish/fish" + fishNo + "_" + tempStr);
        // }
        let fishNo = this.fishTypeInfo.resIndex + 1;
        let fishUrl = "JinChanBuYu/Fish/fish" + fishNo;
    ...
    createMoveAction: function () {
        ...
        switch (this.fishInfo.fishTraceType) {
            ...
            case fishConfig.FishTraceType.Bezier:
                // let JinChanBuYuBezierBy = require("./JinChanBuYuFishBezierBy");
                // let action = new JinChanBuYuBezierBy();
                // let action = new JinChanBuYuFishBezierBy();
