...
cc.Class({
    ...
    properties: {
        ...
        lockLineWidgetCtrl: require("JinChanBuYuLockLineWidgetControl"),
    ...
    initWidget(roomUserInfo, isSelf, posIndex, winGold, changeCannonPowerCallback) {
        ...
        let cannonBackUrl = "JinChanBuYu/cannon/deco" + tempValue;
    ...
    updateCannonPic: function () {
        let gunUrl = "JinChanBuYu/cannon/gun";
        if (this.isSuper === true) {
            gunUrl = "JinChanBuYu/cannon/gun_super_";
        }
        let gunIndex = 1;
    ...
    onLockFish: function (fishCtrl) {
        if (!fishCtrl || !fishCtrl.node) {
            ...
            let lockFishCtrl = this.lockFish.getComponent("JinChanBuYuFishCtrl");
    ...
    onBtnClick: function (event, params) {
        if (params === "addPower") {
            ...
            AudioMgr.playSound('JinChanBuYu/sound/effect/cannonSwitch');
    ...
    showPrize(gainGold, baseValue) {
        ...
        if (rewardTimes < 50) {
            ...
            AudioMgr.playSound('JinChanBuYu/sound/effect/bingo');
            return;
        }
        if (rewardTimes < 100) {
        ...
        if (!!aniCtrl) {
            ...
            AudioMgr.playSound('JinChanBuYu/sound/effect/prize1');
        }
    },
    ...
    showGoldPillar(goldValue, baseValue) {
        ...
        for (let i = 0; i < len; ++i) {
            let pillarctrl = this.pillarList[i].getComponent("JinChanBuYuGoldPillarControl");
            if (i == 0 && len == 4) {
        ...
        let pillarCtrl = pillarItem.getComponent("JinChanBuYuGoldPillarControl");
        let showTime = 0.15;
        let moveDistance = 33;
        let moveDir = 1;
