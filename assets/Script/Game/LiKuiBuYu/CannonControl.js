...
cc.Class({
    ...
    properties: {
        ...
        lockLineWidgetCtrl: require("LockLineWidgetControl"),
    ...
    updateCannonPic: function () {
        let gunUrl = "LiKuiBuYu/cannon/gun";
        if (this.isSuper === true) {
            gunUrl = "LiKuiBuYu/cannon/gun_super_";
        }
        let gunIndex = 1;
    ...
    onLockFish: function (fishCtrl) {
        if (!fishCtrl || !fishCtrl.node) {
            ...
            let lockFishCtrl = this.lockFish.getComponent("LiKuiBuYuFishCtrl");
    ...
    onBtnClick: function (event, params) {
        if (params === "addPower") {
            ...
            AudioMgr.playSound('LiKuiBuYu/sound/effect/cannonSwitch');
    ...
    showPrize(gainGold, baseValue) {
        ...
        if (rewardTimes < 50) {
            ...
            AudioMgr.playSound('LiKuiBuYu/sound/effect/bingo');
            return;
        }
        if (rewardTimes < 100) {
        ...
        if (!!aniCtrl) {
            ...
            AudioMgr.playSound('LiKuiBuYu/sound/effect/prize1');
        }
    },
    ...
    showGoldPillar(goldValue, baseValue) {
        ...
        for (let i = 0; i < len; ++i) {
            let pillarctrl = this.pillarList[i].getComponent("GoldPillarControl");
            if (i == 0 && len == 4) {
        ...
        let pillarCtrl = pillarItem.getComponent("GoldPillarControl");
        let showTime = 0.15;
        let moveDistance = 33;
        let moveDir = 1;
