...
proto.gameStartPush = function (bankerUserChairID, selfCardArr, nextUserChairID, maxBetCount, betCountArr, userStatusArr, drawID, time) {
    return {
...
proto.gameUserBetPush = function (chairID, count, curTurnTotalBetCount, nextUserChairID, curBetCount, maxBetCount, operationType, time) {
    return {
...
proto.gameSendPublicCardPush = function (cardDataArr, nextUserChairID, curBetCount, maxBetCount, totalBetCount, time) {
    return {
...
proto.gameUserGiveUpPush = function (chairID, nextUserChairID, curBetCount, maxBetCount, time) {
    return {
...
// 游戏结果推送
proto.gameResultPush = function (allUserCardArr, scoreChangeArr, winChairIDArr, winType, showPublicCardArr, totalBetCount, profitPercentage) {
    return {
