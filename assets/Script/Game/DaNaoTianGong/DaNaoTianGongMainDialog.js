...
let gameProto = require('./API/DaNaoTianGongProto');
...
cc.Class({
    ...
    properties: {
        cannonBaseArr: [cc.Node],
        cannonPosArr: [cc.Node],
        cannonWidgetPrefab: cc.Prefab,

        fireControlWidgetCtrl: require('DaNaoTianGongFireControl'),

        effectCtrl: require("DaNaoTianGongEffectControl"),
    ...
    start() {
        ...
        this.bgmList = ["DaNaoTianGong/sound/bgm/bgm1", "DaNaoTianGong/sound/bgm/bgm2", "DaNaoTianGong/sound/bgm/bgm3", "DaNaoTianGong/sound/bgm/bgm4"];
        ...
        if (router === 'RoomMessagePush') {
            if (msg.type === roomProto.USER_LEAVE_ROOM_PUSH) {
                if (msg.data.roomUserInfo.userInfo.uid === Global.Player.getPy('uid')) {
                    ViewMgr.goBackHall(Config.GameType.DNTG);
                } else {
    ...
    onBtnClick: function (event, params) {
        ...
        if (params === "exit") {
            ...
            if (musicVolume > 0) {
                ...
                musicVolume = 0;
                Global.CCHelper.updateSpriteFrame('DaNaoTianGong/music_off_btn', musicSpr);
            } else {
                ...
                Global.CCHelper.updateSpriteFrame('DaNaoTianGong/music_on_btn', musicSpr);
            }
            ...
            if (soundVolume > 0) {
                ...
                soundVolume = 0;
                Global.CCHelper.updateSpriteFrame('DaNaoTianGong/effect_off_btn', effectSpr);
            } else {
                ...
                Global.CCHelper.updateSpriteFrame('DaNaoTianGong/effect_on_btn', effectSpr);
            }
            AudioMgr.setSoundVolume(Number(soundVolume));
        } else if (params === "help") {
            Global.DialogManager.createDialog("DaNaoTianGong/DaNaoTianGongHelpDialog");
    ...
    gameInit: function (gameData, roomUserInfoArr) {
        ...
        let backStr = "DaNaoTianGong/background/bg" + this.backIndex;
    ...
    onUserEntry: function (roomUserInfo, curWinGold) {
        ...
        let ctrl = node.getComponent("DaNaoTianGongCannonControl");
    ...
    onSelfFire: function (targetWorldPoint) {
        ...
        this.playSound('DaNaoTianGong/sound/effect/fire1', false, 0.3);
    ...
    showSceneBullet: function (bulletData) {
        ...
        let bulletCtrl = node.getComponent('DaNaoTianGongBulletControl');
    ...
    onFire: function (chairID, bulletdate) {
        ...
        this.playSound('DaNaoTianGong/sound/effect/fire1', false, 0.05);
    ...
    onBeShot: function (bullet, fishCtrl) {
        // 移除子弹
        bullet.onShootFish();
        // this.playSound("DaNaoTianGong/sound/effect/net2", false, 0.3);
        // 播放爆炸动画
        let boomNode = null;
    ...
    onCapture: function (data) {
        ...
        this.playSound('DaNaoTianGong/sound/effect/coin2', false, 0.3);
    ...
    playDieSound: function (fishTypeID, fishID) {
        if (fishTypeID === fishConfig.FishKind.LocalBomb || fishTypeID === fishConfig.FishKind.FixBomb
            ...
            if (fishID % 2 == 0) {
                this.playSound("DaNaoTianGong/sound/effect/boom", false, 0.6);
            } else {
                this.playSound("DaNaoTianGong/sound/effect/superarm", false, 0.6);
            }
            return;
        }
        if (fishTypeID <= fishConfig.FishKind.FishKind10) {
            this.playSound("DaNaoTianGong/sound/effect/" + (fishID % 2 == 0 ? "hit0" : "hit1"), false, 1);
        }
        else {
            this.playSound("DaNaoTianGong/sound/effect/" + (fishID % 2 == 0 ? "m" : "f") + (fishID % 7 + 1), false, 1);
        }
    },
    ...
    createLightning: function (startPos, endPos) {
        ...
        let ctrl = node.getComponent("DaNaoTianGongLighntingWidgetControl");
    ...
    addFish: function (fishInfo, fishDelay, isInit, fixTime) {
        ...
        let ctrl = node.getComponent("DaNaoTianGongFishCtrl");
    ...
    showSpray() {
        ...
        let ctrl = sprayNode.getComponent("DaNaoTianGongSprayWidgetControl");
        ctrl.setInfo(false, sprayActionTime);
        this.playSound("DaNaoTianGong/sound/effect/wave", false, 0.5);
    },
    ...
    loadFishArray2: function (fishDataArray, actionTime) {
        ...
        for (let i = 0; i < len; ++i) {
            ...
            let ctrl = fishNode.getComponent("DaNaoTianGongFishCtrl");
