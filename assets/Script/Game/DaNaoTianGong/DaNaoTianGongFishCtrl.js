...
cc.Class({
    ...
    initWidget(fishInfo, callback, fishDelay, moveTime) {
        ...
        //     urlArr.push("DaNaoTianGong/Fish/fish" + fishNo + "_" + tempStr);
        // }
        let fishNo = this.fishTypeInfo.resIndex + 1;
        let fishUrl = "DaNaoTianGong/Fish/fish" + fishNo;
    ...
    createMoveAction: function () {
        ...
        switch (this.fishInfo.fishTraceType) {
            ...
            case fishConfig.FishTraceType.Bezier:
                // let DaNaoTianGongBezierBy = require("./DaNaoTianGongFishBezierBy");
                // let action = new DaNaoTianGongBezierBy();
                // let action = new DaNaoTianGongFishBezierBy();
