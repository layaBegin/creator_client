...
// 下注推送
proto.gameStartPush = function (drawID, time) {
    return {
...
// 游戏结果推送
proto.gameResultPush = function (scoreChangeArr, allCardDataArr, winTimesArr, cardTypeArr, time, profitPercentage, baseScoreArr) {
    return {
...
// 下注通知
proto.gameUserBetNotify = function (betType, betValue) {
    return {
        type: this.GAME_POURGOLD_NOTIFY,
        data: {
            betType: betType,
